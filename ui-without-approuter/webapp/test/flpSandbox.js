		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI Without Approuter",
									"targetURL": "#nttuiwithoutapprouter-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nttuiwithoutapprouter-display": {
								"semanticObject": "nttuiwithoutapprouter",
								"action": "display",
								"description": "UI Without Approuter",
								"title": "UI Without Approuter",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ntt.uiwithoutapprouter",
									"url": sap.ui.require.toUrl("ntt/uiwithoutapprouter")
								}
							}
						}
					}
